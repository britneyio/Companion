...
.signIn .button .rectangle20 {
    ...
    transform-origin: center;
      ...
      padding-bottom: 0.00px;
      padding-left: 0.00px;
      background-color: rgba(242, 143, 107, 1);
      border-bottom-color: rgba(112, 112, 112, 1);
      border-bottom-style: solid;
      border-bottom-width: 1.00px;
      border-left-color: rgba(112, 112, 112, 1);
      ...
      border-top-style: solid;
      border-top-width: 1.00px;
      border-top-left-radius: 22.00px;
      border-top-right-radius: 22.00px;
      border-bottom-left-radius: 22.00px;
      border-bottom-right-radius: 22.00px;
      box-shadow: none;
      width: 221.00px;
    height: 83.00px;
    left: 0.00px;
...
;
`;
cssText = cssText.replace(/background-image: url\(\"assets/g, `background-image: url("${import.meta.url.replace('signIn.style.js', 'assets')}`);
cssText = cssText.replace(/src: url\(assets/g, `src: url(${import.meta.url.replace('signIn.style.js', 'assets')}`);
export const SignInStyle = html`
${cssText}
`;
